...
object LocaleHelper {
    ...
    private val translations = mapOf(
        "vi" to mapOf(
            ...
            "update_section" to "Cập nhật ứng dụng",
            "current_version" to "Phiên bản hiện tại: %s",
            "check_update" to "🔄 Kiểm tra cập nhật",
            "checking" to "Đang kiểm tra...",
            "up_to_date" to "✅ Đang dùng bản mới nhất",
            "new_version" to "Có bản mới: %s\n%s",
            "download" to "📥 Tải về",
            "update_downloading" to "Đang tải... %d%%",
            "update_done" to "Tải xong! Đang mở cài đặt / thư mục Download...",
            "update_error" to "Lỗi: %s",
            "reading_section" to "Tùy chọn đọc tài liệu",
            "keep_screen_on" to "💡 Luôn giữ sáng màn hình khi đọc",
            "sync_section" to "Tùy chọn đồng bộ",
            "init_sync_state_btn" to "Khởi tạo dữ liệu đồng bộ (Cho file chép tay)",
            "init_sync_status_loading" to "Đang khởi tạo...",
            "init_sync_status_success" to "Khởi tạo thành công! Đã ghi nhận %d file.",
            "init_sync_status_error" to "Lỗi: %s",
            "metadata_colors_title" to "🎨 Màu hiển thị (自社品番, 品番, 自社品名, 品名)",
            "metadata_colors_desc" to "Mặc định nhãn màu xám, giá trị màu nổi bật. Bấm để chọn màu riêng biệt:",
            "label_color" to "Nhãn",
            "value_color" to "Giá trị",
            "custom_hex_title" to "Nhập mã màu Hex",
            "custom_hex_desc" to "Ví dụ: #C62828, #000000, #FF5722",
            "invalid_hex" to "Mã màu không hợp lệ: %s",
            // ── PdfFileAdapter ──
        ...
        "ja" to mapOf(
            ...
            "update_section" to "アプリの更新",
            "current_version" to "現在のバージョン: %s",
            "check_update" to "🔄 更新をチェック",
            "checking" to "確認中...",
            "up_to_date" to "✅ 最新版を使用しています",
            "new_version" to "新しいバージョンがあります: %s\n%s",
            "download" to "📥 ダウンロード",
            "update_downloading" to "ダウンロード中... %d%%",
            "update_done" to "完了しました。インストール / フォルダを開きます...",
            "update_error" to "エラー: %s",
            "reading_section" to "読書設定",
            "keep_screen_on" to "💡 読書中は常に画面をオンにする",
            "sync_section" to "同期設定",
            "init_sync_state_btn" to "同期データの初期化（手動コピーファイル用）",
            "init_sync_status_loading" to "初期化中...",
            "init_sync_status_success" to "初期化成功！%d個のファイルを記録しました。",
            "init_sync_status_error" to "エラー: %s",
            "metadata_colors_title" to "🎨 表示カラー設定 (自社品番, 品番, 自社品名, 品名)",
            "metadata_colors_desc" to "デフォルトでラベルは灰色、値は強調色です。タップして個別に変更:",
            "label_color" to "ラベル",
            "value_color" to "値",
            "custom_hex_title" to "Hexカラーコード入力",
            "custom_hex_desc" to "例: #C62828, #000000, #FF5722",
            "invalid_hex" to "無効なカラーコードです: %s",
            // ── PdfFileAdapter ──
            "status_read" to "✓ 既読",
            "status_unread" to "未読",
