...
public class BaseBridge implements aa {
    ...
    @Override public void a(Context context, int i, int i2) {}
    ...
    @Override public native boolean createCanvasAndBitmap(int i, int i2);
    ...
    @Override public native boolean drawDoublePage(Canvas canvas, int i, int i2, int i3, int i4, float f, int i5, float f2, float f3, float f4, float f5, float f6, float f7);
    @Override public native boolean drawDoublePageEx(Canvas canvas, int i, int i2, int i3, int i4, float f, int i5, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11, float f12, float f13, float f14, float f15, float f16);
    @Override public native boolean drawPage(Canvas canvas, int i, int i2, float f, int i3, float f2, float f3, float f4, float f5, float f6, float f7);
    @Override public native boolean drawPageEx(Canvas canvas, int i, int i2, float f, int i3, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11, float f12, float f13, float f14, float f15, float f16);
    ...
    @Override public native boolean isAllTiledsOver();
    public native boolean isBinder();
    public native boolean isContentDoc();
    @Override public native boolean isCurrentTiledsOver();
    ...
    @Override public native boolean preDraw(int i, int i2, float f, float f2, float f3, float f4, float f5);
