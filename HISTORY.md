...
- 03/07/2026 17:08: **Thêm cài đặt "Tùy chọn đồng bộ"**: Chuyển tính năng "Nhận diện file chép thủ công" thành một tuỳ chọn có thể bật/tắt (Switch) trong màn hình `⚙ Setting`, hỗ trợ đa ngôn ngữ Việt/Nhật. Mặc định tính năng này được bật.
